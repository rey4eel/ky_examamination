  ...
  <body>
    ...
    <!--  first row buttons  -->
      <div class="button__first__line">
        <div>
          <a href="#"><button class="button1"><img src="/img/new_logo/db.PNG" width="76" height="57" alt="examination1"><span class="button__text">KNOWLEDGE BASE</span></button></a>
        </div>
		  <div>
			  <a href="#"><button class="button1" onclick="document.location='/calendar_test.php'"><img src="/img/new_logo/calendar.png" width="76" height="57" alt="examination1"><span class="button__text">CHECK SCHEDULER</span></button></a>
		  </div>
        <div>
          <a href="#"><button class="button1"><img src="/img/new_logo/info.PNG" width="76" height="57" alt="examination2"><span class="button__text">ABOUT EXAMINATION</span></button></a>
        </div>
      </div>
	...
	<script src="/js/signdrop.js"></script>
  </body>
</html>